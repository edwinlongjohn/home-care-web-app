<template>
        ...
        <div class="sidemenu-content"><button class="closeButton sideMenuCls"><i class="far fa-times"></i></button>
            <div class="widget">
                <div class="th-widget-about">
                    <div class="about-logo"><a href="home-medical-clinic.html"><img src="/assets/img/logo.svg"
                                alt="Mediax"></a></div>
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center"><button class="th-menu-toggle"><i class="fal fa-times"></i></button>
            <div class="mobile-logo"><a href="home-medical-clinic.html"><img src="/assets/img/logo.svg" alt="Mediax"></a>
            </div>
            <div class="th-mobile-menu">
                <ul>
                    <li class="menu-item-has-children"><a href="home-medical-clinic.html">Home</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="home-ophthalmology.html">Home Ophthalmology</a></li>
                            <li><a href="home-pediatrics.html">Home Pediatrics</a></li>
                            <li><a href="home-gynecology.html">Home Gynecology</a></li>
                            <li><a href="home-aesthetic-dentistry.html">Aesthetic Dentistry</a></li>
                            <li><a href="home-medical-cosmetics.html">Medical Cosmetics</a></li>
                        </ul>
                    </li>
    ...
    <div class="th-hero-wrapper hero-2" id="hero" data-bg-src="/assets/img/hero/hero_bg_2_1.jpg">
        <div class="hero-inner">
            <div class="container">
                <div class="hero-style2"><span class="sub-title"><img src="/assets/img/theme-img/title_icon.svg"
                            alt="shape">24/7 Emergency Service</span>
                    <h1 class="hero-title2"><span class="title1">Caring for <span class="line-text">Health</span></span>
                        <span class="title2">Caring for You</span></h1>
                    ...
                    <div class="btn-group justify-content-center"><a href="about.html" class="th-btn">Discover More</a>
                        <a href="service.html" class="th-btn style4">See All Services</a></div>
                </div>
            </div>
            <div class="hero-img"><img src="/assets/img/hero/hero_2_1.png" alt="Image"></div>
            <div class="hero-shape1"><img src="/assets/img/hero/hero_shape_2_1.svg" alt="shape"></div>
            <div class="hero-shape2"><img src="/assets/img/hero/hero_shape_2_2.svg" alt="shape"></div>
            <div class="hero-shape3"><img src="/assets/img/hero/hero_shape_2_3.svg" alt="shape"></div>
            <div class="hero-shape4"><img src="/assets/img/hero/hero_shape_2_4.svg" alt="shape"></div>
            <div class="hero-shape5"><img src="/assets/img/hero/hero_shape_2_5.svg" alt="shape"></div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 mb-30 mb-xl-0">
                    <div class="img-box1">
                        <div class="img1"><img src="/assets/img/normal/about_1_3.png" alt="About"></div>
                        <div class="about-info">
                            ...
                            </div><a href="tel:+16356478965" class="box-link"><i class="fa-solid fa-phone"></i> +163 564
                                78965</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="ps-xxl-4 ms-xl-2 text-center text-xl-start">
                        <div class="title-area mb-32"><span class="sub-title"><img
                                    src="/assets/img/theme-img/title_icon.svg" alt="shape">About Us Company</span>
                            <h2 class="sec-title">Affordable Health Care Solutions</h2>
                            <p class="sec-text">A brief statement outlining the purpose and mission of the clinic. This
                                can include the commitment to patient care, community health, and any specifical goals
                                for our values.</p>
                        </div>
                        ...
                        <div><a href="about.html" class="th-btn">More About Us</a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="/assets/img/service/service_card_1.jpg">
                        <div class="box-shape"><img src="/assets/img/bg/service_card_bg.png" alt="Service"></div>
                        ...
                        <p class="box-text">30+ Doctors</p><a href="service-details.html"
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="/assets/img/service/service_card_2.jpg">
                        ...
                        <p class="box-text">20+ Doctors</p><a href="service-details.html"
                            class="th-btn btn-sm style2 theme-color">Read More</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="/assets/img/service/service_card_4.jpg">
                        ...
                        <p class="box-text">10+ Doctors</p><a href="service-details.html"
                            class="th-btn btn-sm style2 theme-color">Read More</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="/assets/img/service/service_card_6.jpg">
                        ...
                        <p class="box-text">24+ Doctors</p><a href="service-details.html"
                            class="th-btn btn-sm style2 theme-color">Read More</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="/assets/img/service/service_card_7.jpg">
                        ...
                        <p class="box-text">26+ Doctors</p><a href="service-details.html"
                            class="th-btn btn-sm style2 theme-color">Read More</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
        ...
        <div class="container z-index-common">
            <div class="row align-items-end justify-content-center text-center text-xl-start">
                <div class="col-xl-7 col-lg-9 space-extra">
                    ...
                    <div class="btn-group justify-content-center"><a href="contact.html" class="th-btn shadow-1">Book
                            Appointment</a> <a href="contact.html" class="th-btn style2 shadow-1">Get Free
                            Consulting</a></div>
                </div>
                <div class="col-xl-5">
                    <div class="img-box2"><img src="/assets/img/normal/cta_1.png" alt="image"></div>
                </div>
            </div>
        </div>
    </section>
    <div class="overflow-hidden space">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="img-box3"><img src="/assets/img/normal/why_1.jpg" alt="Why"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="counter-card-wrap">
                <div class="counter-card">
                    <h2 class="box-number"><span class="number"><span class="counter-number">69</span>k</span><span
                            class="plus">+</span></h2>
                    <p class="box-text">Satisfied Patients</p>
                </div>
                <div class="divider"></div>
                <div class="counter-card">
                    <h2 class="box-number"><span class="number"><span class="counter-number">236</span></span><span
                            class="plus">+</span></h2>
                    <p class="box-text">Professional Doctors</p>
                </div>
                <div class="divider"></div>
                <div class="counter-card">
                    <h2 class="box-number"><span class="number"><span class="counter-number">19</span>k</span><span
                            class="plus">+</span></h2>
                    <p class="box-text">Operations Successful</p>
                </div>
                <div class="divider"></div>
                <div class="counter-card">
                    <h2 class="box-number"><span class="number"><span class="counter-number">320</span></span><span
                            class="plus">+</span></h2>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="th-team team-card">
                            <div class="box-img"><img src="/assets/img/team/team_1_1.jpg" alt="Team">
                                <div class="th-social"><a target="_blank" href="https://facebook.com/"><i
                                        ...
                                        target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            ...
                            <h3 class="box-title"><a href="team-details.html">Dr. Rishita Rosei</a></h3><span
                                class="team-desig">Neurologist</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            ...
                            <h3 class="box-title"><a href="team-details.html">Dr. Emanuyel Mac</a></h3><span
                                class="team-desig">Physiotherapist</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            ...
                            <h3 class="box-title"><a href="team-details.html">Dr. Wilium Lily</a></h3><span
                                class="team-desig">Cardiologist</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            ...
                            <h3 class="box-title"><a href="team-details.html">Dr. Esabel Macran</a></h3><span
                                class="team-desig">Dentist</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="overflow-hidden space">
        <div class="container">
            <div class="appointment-row">
                ...
                <div class="form-wrap">
                    <div class="img-box4">
                        <div class="img1"><img src="/assets/img/normal/form_1_1.jpg" alt="Image"></div>
                        <div class="img2"><img src="/assets/img/normal/form_1_2.jpg" alt="Image"></div>
                    </div>
                    <form action="https://html.themeholy.com/mediax/demo/mail.php" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12"><select name="subject" id="subject" class="form-select">
                                    <option value="" disabled="disabled" selected="selected" hidden>Choose Department
                                    </option>
                            ...
                            <div class="form-group col-6"><input type="text" class="date-pick form-control" name="date"
                                    id="date-pick" placeholder="Date"></div>
                            <div class="form-group col-6"><input type="text" class="time-pick form-control" name="time"
                                    id="time-pick" placeholder="Time"></div>
    ...
    <section class="space" data-bg-src="/assets/img/bg/process_bg_1.jpg">
        <div class="container">
            <div class="title-area text-center"><span class="sub-title"><img src="/assets/img/theme-img/title_icon.svg"
                        alt="Icon">Work Process</span>
                <h2 class="sec-title">Let’s See How We Work Process</h2>
            </div>
            <div class="process-card-wrap">
                <div class="process-card">
                    <div class="box-img">
                        <div class="img"><img src="/assets/img/normal/process_card_1.jpg" alt="icon"></div>
                ...
                <div class="process-card">
                    <div class="box-img">
                        <div class="img"><img src="/assets/img/normal/process_card_2.jpg" alt="icon"></div>
                ...
                <div class="process-card">
                    <div class="box-img">
                        <div class="img"><img src="/assets/img/normal/process_card_3.jpg" alt="icon"></div>
                ...
                <div class="process-card">
                    <div class="box-img">
                        <div class="img"><img src="/assets/img/normal/process_card_4.jpg" alt="icon"></div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            <div class="accordion-card">
                                <div class="accordion-header" id="collapse-item-1"><button class="accordion-button"
                                        ...
                                        aria-expanded="true" aria-controls="collapse-1">01. What services does the
                                        clinic offer?</button></div>
                            ...
                            <div class="accordion-card">
                                <div class="accordion-header" id="collapse-item-2"><button
                                        ...
                                        aria-controls="collapse-2">02. How do I schedule an appointment?</button></div>
                            ...
                            <div class="blog-card">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.html">Strategies Against Corporate
                                            Intrusion in Healthcare</a></h3><a href="blog-details.html"
                                        class="th-btn btn-sm">Read More</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="blog-card">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.html">Transform Your Nutrition with
                                            Organic Meal</a></h3><a href="blog-details.html" class="th-btn btn-sm">Read
                                        More</a>
                                </div>
                            </div>
                        </div>
